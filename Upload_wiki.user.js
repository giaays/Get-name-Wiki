...
`,A.appendChild(ne),te.appendChild(A),document.createElement("div"));oe.style.cssText="margin-bottom: 12px; padding: 0 4px; display: none;";$=document.createElement("div");$.textContent="Số dòng trắng giữa các chương:",$.style.cssText="color: #495057; font-size: 13px; margin-bottom: 6px; font-weight: 600;",oe.appendChild($);const ie=document.createElement("input");ie.type="number",ie.min="1",ie.value="2",ie.style.cssText=`
    width: 100%;
    padding: 8px;
    border: 1px solid #d6cfc4;
    border-radius: 6px;
